...
/**
 * The class is used for implementing the "OdlCardinalProjectModule" group.
 * The group is defined with the following oid: 1.3.6.1.3.1.1.8.
 */
public class OdlCardinalProjectModule implements OdlCardinalProjectModuleMBean, Serializable {

    /**
     * Variable for storing the value of "OdlMDSALBGPBMPinfo".
     * The variable is identified by: "1.3.6.1.3.1.1.8.17".
     */
    protected String OdlMDSALBGPBMPinfo = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALBGPRIBInfo".
     * The variable is identified by: "1.3.6.1.3.1.1.8.16".
     */
    protected String OdlMDSALBGPRIBInfo = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALBGPPeerInfo".
    ...
    /**
     * Variable for storing the value of "OdlMDSALIotDMlistofNodes".
     * The variable is identified by: "1.3.6.1.3.1.1.8.13".
     */
    protected String OdlMDSALIotDMlistofNodes = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALIotDMlistofAEs".
     * The variable is identified by: "1.3.6.1.3.1.1.8.12".
     */
    protected String OdlMDSALIotDMlistofAEs = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALIotDMListofcse".
     * The variable is identified by: "1.3.6.1.3.1.1.8.11".
     */
    protected String OdlMDSALIotDMListofcse = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALGBPPolicytenants".
     * The variable is identified by: "1.3.6.1.3.1.1.8.10".
     */
    protected String OdlMDSALGBPPolicytenants = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALGBPFaaslogicalnetwork".
     * The variable is identified by: "1.3.6.1.3.1.1.8.9".
     */
    protected String OdlMDSALGBPFaaslogicalnetwork = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALService".
     * The variable is identified by: "1.3.6.1.3.1.1.8.8".
     */
    protected String OdlMDSALService = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALServicefunctiontype".
     * The variable is identified by: "1.3.6.1.3.1.1.8.7".
     */
    protected String OdlMDSALServicefunctiontype = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALSfcfunctionAlgorithms".
     * The variable is identified by: "1.3.6.1.3.1.1.8.6".
     */
    protected String OdlMDSALSfcfunctionAlgorithms = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALSfcfunctiongroups".
     * The variable is identified by: "1.3.6.1.3.1.1.8.5".
     */
    protected String OdlMDSALSfcfunctiongroups = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALSfcfunctionchain".
     * The variable is identified by: "1.3.6.1.3.1.1.8.4".
     */
    protected String OdlMDSALSfcfunctionchain = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALSfcfunction".
     * The variable is identified by: "1.3.6.1.3.1.1.8.3".
     */
    protected String OdlMDSALSfcfunction = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALNetconfConnectedDevices".
     * The variable is identified by: "1.3.6.1.3.1.1.8.2".
     */
    protected String OdlMDSALNetconfConnectedDevices = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALClustershardsshared".
     * The variable is identified by: "1.3.6.1.3.1.1.8.1".
     */
    protected String OdlMDSALClustershardsshared = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlMDSALClusterControllerRole".
     * The variable is identified by: "1.3.6.1.3.1.1.8.0".
     */
    protected String OdlMDSALClusterControllerRole = new String("JDMK 5.1");


    /**
     * Constructor for the "OdlCardinalProjectModule" group.
