...
/**
 * The class is used for representing SNMP metadata for the "OdlCardinalKarafShellModule" group.
 * The group is defined with the following oid: 1.3.6.1.3.1.1.7.
 */
public class OdlCardinalKarafShellModuleMeta extends SnmpMibGroup
