...
/**
 * The class is used for representing SNMP metadata for the "OdlNetconfStats2"
 * group. The group is defined with the following oid: 1.3.6.1.3.1.1.15.
 */
public class OdlNetconfStats2Meta extends SnmpMibGroup implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "OdlNetconfStats2".
     */
    public OdlNetconfStats2Meta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data) throws SnmpStatusException {
        switch ((int) var) {
        case 4:
            return new SnmpString(node.getOdlNetconfStatus2());

        case 3:
            return new SnmpString(node.getOdlNetconfPort2());

        case 2:
            return new SnmpString(node.getOdlNetconfHost2());

        case 1:
            return new SnmpString(node.getOdlNetconfNodeId2());
    ...
    public SnmpValue set(SnmpValue x, long var, Object data) throws SnmpStatusException {
        ...
        case 4:
            if (x instanceof SnmpString) {
                node.setOdlNetconfStatus2(((SnmpString) x).toString());
                return new SnmpString(node.getOdlNetconfStatus2());
            } else {
        ...
        case 3:
            if (x instanceof SnmpString) {
                node.setOdlNetconfPort2(((SnmpString) x).toString());
                return new SnmpString(node.getOdlNetconfPort2());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
        ...
        case 2:
            if (x instanceof SnmpString) {
                node.setOdlNetconfHost2(((SnmpString) x).toString());
                return new SnmpString(node.getOdlNetconfHost2());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
        ...
        case 1:
            if (x instanceof SnmpString) {
                node.setOdlNetconfNodeId2(((SnmpString) x).toString());
                return new SnmpString(node.getOdlNetconfNodeId2());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
    ...
    public void check(SnmpValue x, long var, Object data) throws SnmpStatusException {
        ...
        case 4:
            if (x instanceof SnmpString) {
                node.checkOdlNetconfStatus2(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
        ...
        case 3:
            if (x instanceof SnmpString) {
                node.checkOdlNetconfPort2(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
        ...
        case 2:
            if (x instanceof SnmpString) {
                node.checkOdlNetconfHost2(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
        ...
        case 1:
            if (x instanceof SnmpString) {
                node.checkOdlNetconfNodeId2(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
     ...
     */
    protected void setInstance(OdlNetconfStats2MBean var) {
        node = var;
    }
    ...
    protected OdlNetconfStats2MBean node;
