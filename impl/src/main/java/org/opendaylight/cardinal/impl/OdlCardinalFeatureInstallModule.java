...
/**
 * The class is used for implementing the "OdlCardinalFeatureInstallModule" group.
 * The group is defined with the following oid: 1.3.6.1.3.1.1.2.
 */
public class OdlCardinalFeatureInstallModule implements OdlCardinalFeatureInstallModuleMBean, Serializable {

    /**
     * Variable for storing the value of "FeatureInstalled9".
     * The variable is identified by: "1.3.6.1.3.1.1.2.9".
     */
    protected String FeatureInstalled9 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "FeatureInstalled8".
     * The variable is identified by: "1.3.6.1.3.1.1.2.8".
     */
    protected String FeatureInstalled8 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "FeatureInstalled7".
     * The variable is identified by: "1.3.6.1.3.1.1.2.7".
     */
    protected String FeatureInstalled7 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "FeatureInstalled6".
     * The variable is identified by: "1.3.6.1.3.1.1.2.6".
     */
    protected String FeatureInstalled6 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "FeatureInstalled5".
     * The variable is identified by: "1.3.6.1.3.1.1.2.5".
     */
    protected String FeatureInstalled5 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "FeatureInstalled4".
     * The variable is identified by: "1.3.6.1.3.1.1.2.4".
     */
    protected String FeatureInstalled4 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "FeatureInstalled3".
     * The variable is identified by: "1.3.6.1.3.1.1.2.3".
     */
    protected String FeatureInstalled3 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "FeatureInstalled2".
     * The variable is identified by: "1.3.6.1.3.1.1.2.2".
     */
    protected String FeatureInstalled2 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "FeatureInstalled1".
     * The variable is identified by: "1.3.6.1.3.1.1.2.1".
     */
    protected String FeatureInstalled1 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "FeatureInstalled10".
     * The variable is identified by: "1.3.6.1.3.1.1.2.10".
     */
    protected String FeatureInstalled10 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlKarafFeatureListInstalled".
     * The variable is identified by: "1.3.6.1.3.1.1.2.0".
     */
    protected String OdlKarafFeatureListInstalled = new String("JDMK 5.1");


    /**
     * Constructor for the "OdlCardinalFeatureInstallModule" group.
