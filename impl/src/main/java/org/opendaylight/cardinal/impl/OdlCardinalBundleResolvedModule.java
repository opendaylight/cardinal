...
/**
 * The class is used for implementing the "OdlCardinalBundleResolvedModule" group.
...
public class OdlCardinalBundleResolvedModule implements OdlCardinalBundleResolvedModuleMBean, Serializable {
    ...
    /**
     * Variable for storing the value of "ResolvedBundle5".
     * The variable is identified by: "1.3.6.1.3.1.1.6.5".
     */
    protected String ResolvedBundle5 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "ResolvedBundle4".
     * The variable is identified by: "1.3.6.1.3.1.1.6.4".
     */
    protected String ResolvedBundle4 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "ResolvedBundle3".
     * The variable is identified by: "1.3.6.1.3.1.1.6.3".
     */
    protected String ResolvedBundle3 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "ResolvedBundle2".
     * The variable is identified by: "1.3.6.1.3.1.1.6.2".
     */
    protected String ResolvedBundle2 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "ResolvedBundle1".
     * The variable is identified by: "1.3.6.1.3.1.1.6.1".
     */
    protected String ResolvedBundle1 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlKarafBundleListResolved".
     * The variable is identified by: "1.3.6.1.3.1.1.6.0".
     */
    protected String OdlKarafBundleListResolved = new String("JDMK 5.1");


    /**
     * Constructor for the "OdlCardinalBundleResolvedModule" group.
