...
/**
 * The class is used for representing SNMP metadata for the "OdlNetconfStats1"
 * group. The group is defined with the following oid: 1.3.6.1.3.1.1.14.
 */
public class OdlNetconfStats1Meta extends SnmpMibGroup implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "OdlNetconfStats1".
     */
    public OdlNetconfStats1Meta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data) throws SnmpStatusException {
        switch ((int) var) {
        case 4:
            return new SnmpString(node.getOdlNetconfStatus1());

        case 3:
            return new SnmpString(node.getOdlNetconfPort1());

        case 2:
            return new SnmpString(node.getOdlNetconfHost1());

        case 1:
            return new SnmpString(node.getOdlNetconfNodeId1());
    ...
    public SnmpValue set(SnmpValue x, long var, Object data) throws SnmpStatusException {
        ...
        case 4:
            if (x instanceof SnmpString) {
                node.setOdlNetconfStatus1(((SnmpString) x).toString());
                return new SnmpString(node.getOdlNetconfStatus1());
            } else {
        ...
        case 3:
            if (x instanceof SnmpString) {
                node.setOdlNetconfPort1(((SnmpString) x).toString());
                return new SnmpString(node.getOdlNetconfPort1());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
        ...
        case 2:
            if (x instanceof SnmpString) {
                node.setOdlNetconfHost1(((SnmpString) x).toString());
                return new SnmpString(node.getOdlNetconfHost1());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
        ...
        case 1:
            if (x instanceof SnmpString) {
                node.setOdlNetconfNodeId1(((SnmpString) x).toString());
                return new SnmpString(node.getOdlNetconfNodeId1());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
    ...
    public void check(SnmpValue x, long var, Object data) throws SnmpStatusException {
        ...
        case 4:
            if (x instanceof SnmpString) {
                node.checkOdlNetconfStatus1(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
        ...
        case 3:
            if (x instanceof SnmpString) {
                node.checkOdlNetconfPort1(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
        ...
        case 2:
            if (x instanceof SnmpString) {
                node.checkOdlNetconfHost1(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
        ...
        case 1:
            if (x instanceof SnmpString) {
                node.checkOdlNetconfNodeId1(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
     ...
     */
    protected void setInstance(OdlNetconfStats1MBean var) {
        node = var;
    }
    ...
    protected OdlNetconfStats1MBean node;
