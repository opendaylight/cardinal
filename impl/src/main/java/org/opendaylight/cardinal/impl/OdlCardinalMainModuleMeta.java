 ...
 * "OdlCardinalMainModule" group. The group is defined with the following oid:
 * 1.3.6.1.3.1.1.1.
 */
public class OdlCardinalMainModuleMeta extends SnmpMibGroup implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "OdlCardinalMainModule".
     */
    public OdlCardinalMainModuleMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue set(SnmpValue x, long var, Object data) throws SnmpStatusException {
        ...
        case 6:
            if (x instanceof SnmpString) {
                node.setOdlSystemOdlNodeInfo(((SnmpString) x).toString());
                return new SnmpString(node.getOdlSystemOdlNodeInfo());
            } else {
        ...
        case 4:
            if (x instanceof SnmpString) {
                node.setOdlSystemSysInfo(((SnmpString) x).toString());
                return new SnmpString(node.getOdlSystemSysInfo());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
        ...
        case 3:
            if (x instanceof SnmpString) {
                node.setOdlSystemHostAddress(((SnmpString) x).toString());
                return new SnmpString(node.getOdlSystemHostAddress());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
    ...
    public void check(SnmpValue x, long var, Object data) throws SnmpStatusException {
        ...
        case 6:
            if (x instanceof SnmpString) {
                node.checkOdlSystemOdlNodeInfo(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
        ...
        case 4:
            if (x instanceof SnmpString) {
                node.checkOdlSystemSysInfo(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
        ...
        case 3:
            if (x instanceof SnmpString) {
                node.checkOdlSystemHostAddress(((SnmpString) x).toString());
            } else {
                throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
            }
            break;
     ...
     */
    protected void setInstance(OdlCardinalMainModuleMBean var) {
        node = var;
    }
    ...
    protected OdlCardinalMainModuleMBean node;
