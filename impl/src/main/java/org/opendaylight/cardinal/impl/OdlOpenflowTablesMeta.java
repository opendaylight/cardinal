...
/**
 * The class is used for representing SNMP metadata for the "OdlOpenflowTables"
 * group. The group is defined with the following oid: 1.3.6.1.3.1.1.13.
 */
public class OdlOpenflowTablesMeta extends SnmpMibGroup implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "OdlOpenflowTables".
     */
    public OdlOpenflowTablesMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
     ...
     */
    protected void setInstance(OdlOpenflowTablesMBean var) {
        node = var;
    }
    ...
    public void registerTableNodes(SnmpMib mib, MBeanServer server) {
        tableNetOpenflowTable = createNetOpenflowTableMetaNode("NetOpenflowTable", "OdlOpenflowTables", mib, server);
        if (tableNetOpenflowTable != null) {
            tableNetOpenflowTable.registerEntryNode(mib, server);
            mib.registerTableMeta("NetOpenflowTable", tableNetOpenflowTable);
        }
