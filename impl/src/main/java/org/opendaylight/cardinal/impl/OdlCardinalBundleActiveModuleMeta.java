...
/**
 * The class is used for representing SNMP metadata for the "OdlCardinalBundleActiveModule" group.
 * The group is defined with the following oid: 1.3.6.1.3.1.1.4.
 */
public class OdlCardinalBundleActiveModuleMeta extends SnmpMibGroup
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "OdlCardinalBundleActiveModule".
     */
