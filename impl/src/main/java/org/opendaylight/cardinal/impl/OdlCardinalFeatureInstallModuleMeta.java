...
/**
 * The class is used for representing SNMP metadata for the "OdlCardinalFeatureInstallModule" group.
 * The group is defined with the following oid: 1.3.6.1.3.1.1.2.
 */
public class OdlCardinalFeatureInstallModuleMeta extends SnmpMibGroup
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "OdlCardinalFeatureInstallModule".
     */
