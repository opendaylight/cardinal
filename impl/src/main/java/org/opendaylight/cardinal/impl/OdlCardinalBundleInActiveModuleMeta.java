...
/**
 * The class is used for representing SNMP metadata for the "OdlCardinalBundleInActiveModule" group.
 * The group is defined with the following oid: 1.3.6.1.3.1.1.5.
 */
public class OdlCardinalBundleInActiveModuleMeta extends SnmpMibGroup
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "OdlCardinalBundleInActiveModule".
     */
