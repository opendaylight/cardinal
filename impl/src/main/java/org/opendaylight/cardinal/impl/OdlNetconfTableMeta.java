 ...
 */
public class OdlNetconfTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "OdlNetconfTableMeta".
     ...
     */
    public OdlNetconfTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
        objectserver = objserv;
    }

    /**
     * Factory method for "OdlNetconfEntry" entry metadata class.
     *
     ...
     *         "OdlNetconfEntry" conceptual row (OdlNetconfEntryMeta)
     *
     **/
    protected OdlNetconfEntryMeta createOdlNetconfEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib,
            MBeanServer server) {
        return new OdlNetconfEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server) {
        node = createOdlNetconfEntryMetaNode("OdlNetconfEntry", "OdlNetconfTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname, Object entry) throws SnmpStatusException {
        if (!(entry instanceof OdlNetconfEntryMBean))
            throw new ClassCastException("Entries for Table \"" + "OdlNetconfTable" + "\" must implement the \""
                    + "OdlNetconfEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth) throws SnmpStatusException {
        OdlNetconfEntryMBean entry = (OdlNetconfEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private OdlNetconfEntryMeta node;
