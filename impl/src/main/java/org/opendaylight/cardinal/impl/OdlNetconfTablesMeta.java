...
/**
 * The class is used for representing SNMP metadata for the "OdlNetconfTables"
 * group. The group is defined with the following oid: 1.3.6.1.3.1.1.16.
 */
public class OdlNetconfTablesMeta extends SnmpMibGroup implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "OdlNetconfTables".
     */
    public OdlNetconfTablesMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
     ...
     */
    protected void setInstance(OdlNetconfTablesMBean var) {
        node = var;
    }
    ...
    public void registerTableNodes(SnmpMib mib, MBeanServer server) {
        tableOdlNetconfTable = createOdlNetconfTableMetaNode("OdlNetconfTable", "OdlNetconfTables", mib, server);
        if (tableOdlNetconfTable != null) {
            tableOdlNetconfTable.registerEntryNode(mib, server);
            mib.registerTableMeta("OdlNetconfTable", tableOdlNetconfTable);
        }

    }

    /**
     * Factory method for "OdlNetconfTable" table metadata class.
     *
     * You can redefine this method if you need to replace the default generated
     * metadata class with your own customized class.
     *
     * @param tableName
     *            Name of the table object ("OdlNetconfTable")
     * @param groupName
     ...
     *         "OdlNetconfTable" table (OdlNetconfTableMeta)
     *
     **/
    protected OdlNetconfTableMeta createOdlNetconfTableMetaNode(String tableName, String groupName, SnmpMib mib,
            MBeanServer server) {
        return new OdlNetconfTableMeta(mib, objectserver);
    }

    protected OdlNetconfTablesMBean node;
    protected SnmpStandardObjectServer objectserver = null;
    protected OdlNetconfTableMeta tableOdlNetconfTable = null;
}
