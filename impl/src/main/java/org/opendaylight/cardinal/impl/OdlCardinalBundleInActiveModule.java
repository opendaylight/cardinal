...
/**
 * The class is used for implementing the "OdlCardinalBundleInActiveModule" group.
 * The group is defined with the following oid: 1.3.6.1.3.1.1.5.
 */
public class OdlCardinalBundleInActiveModule implements OdlCardinalBundleInActiveModuleMBean, Serializable {

    /**
     * Variable for storing the value of "InstalledBundle5".
     * The variable is identified by: "1.3.6.1.3.1.1.5.5".
     */
    protected String InstalledBundle5 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "InstalledBundle4".
     * The variable is identified by: "1.3.6.1.3.1.1.5.4".
     */
    protected String InstalledBundle4 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "InstalledBundle3".
     * The variable is identified by: "1.3.6.1.3.1.1.5.3".
     */
    protected String InstalledBundle3 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "InstalledBundle2".
     * The variable is identified by: "1.3.6.1.3.1.1.5.2".
     */
    protected String InstalledBundle2 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "InstalledBundle1".
     * The variable is identified by: "1.3.6.1.3.1.1.5.1".
     */
    protected String InstalledBundle1 = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlKarafBundleListInstalled".
     * The variable is identified by: "1.3.6.1.3.1.1.5.0".
     */
    protected String OdlKarafBundleListInstalled = new String("JDMK 5.1");


    /**
     * Constructor for the "OdlCardinalBundleInActiveModule" group.
