...
/**
 * The class is used for implementing the "OdlCardinalMainModule" group.
 * The group is defined with the following oid: 1.3.6.1.3.1.1.1.
 */
public class OdlCardinalMainModule implements OdlCardinalMainModuleMBean, Serializable {

    /**
     * Variable for storing the value of "OdlSystemOdlNodeInfo".
     * The variable is identified by: "1.3.6.1.3.1.1.1.6".
     */
    protected String OdlSystemOdlNodeInfo = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlSystemOdlUptime".
     * The variable is identified by: "1.3.6.1.3.1.1.1.5".
     */
    protected String OdlSystemOdlUptime = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlSystemSysInfo".
     * The variable is identified by: "1.3.6.1.3.1.1.1.4".
     */
    protected String OdlSystemSysInfo = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlSystemHostAddress".
     * The variable is identified by: "1.3.6.1.3.1.1.1.3".
     */
    protected String OdlSystemHostAddress = new String("JDMK 5.1");

    /**
     * Variable for storing the value of "OdlSystemMemUsage".
     * The variable is identified by: "1.3.6.1.3.1.1.1.2".
     */
    protected Integer OdlSystemMemUsage = new Integer(1);

    /**
     * Variable for storing the value of "OdlSystemCpuUsage".
     * The variable is identified by: "1.3.6.1.3.1.1.1.1".
     */
    protected Integer OdlSystemCpuUsage = new Integer(1);


    /**
     * Constructor for the "OdlCardinalMainModule" group.
