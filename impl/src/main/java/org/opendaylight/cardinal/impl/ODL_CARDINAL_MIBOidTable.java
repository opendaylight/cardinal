...
/**
 * The class contains metadata definitions for "ODL-CARDINAL-MIB".
 * Call SnmpOid.setSnmpOidTable(new ODL_CARDINAL_MIBOidTable()) to load the metadata in the SnmpOidTable.
 */
public class ODL_CARDINAL_MIBOidTable extends SnmpOidTableSupport implements Serializable {
    ...
    static SnmpOidRecord varList [] = {
        new SnmpOidRecord("odlMDSALBGPBMPinfo", "1.3.6.1.3.1.1.8.17", "S"),
