...
public class ODL_CARDINAL_MIBOidTable extends SnmpOidTableSupport implements Serializable {
    ...
    static SnmpOidRecord varList[] = { new SnmpOidRecord("resolvedBundle5", "1.3.6.1.3.1.1.6.5", "S"),
            ...
            new SnmpOidRecord("odlKarafBundleListActive", "1.3.6.1.3.1.1.4.0", "S"),
            ...
            new SnmpOidRecord("odlSystemHostAddressTrap", "1.3.6.1.3.1.1.1.36", "S"),
            new SnmpOidRecord("odlSystemMemUsage", "1.3.6.1.3.1.1.1.2", "I"),
            new SnmpOidRecord("odlMDSALGBPResolvedpolicies", "1.3.6.1.3.1.1.1.11", "S"),
            new SnmpOidRecord("odlSystemCpuUsage", "1.3.6.1.3.1.1.1.1", "I"),
            new SnmpOidRecord("odlMDSALBGPBMPinfo", "1.3.6.1.3.1.1.8.18", "S"),
            new SnmpOidRecord("odlMDSALBGPRIBInfo", "1.3.6.1.3.1.1.8.17", "S"),
            new SnmpOidRecord("odlMDSALBGPPeerInfo", "1.3.6.1.3.1.1.8.16", "S"),
            new SnmpOidRecord("odlMDSALOpenFlowOVSconnectedDevices", "1.3.6.1.3.1.1.8.15", "S"),
            new SnmpOidRecord("odlMDSALIotDMlistofNodes", "1.3.6.1.3.1.1.8.14", "S"),
            new SnmpOidRecord("odlMDSALIotDMlistofAEs", "1.3.6.1.3.1.1.8.13", "S"),
            new SnmpOidRecord("odlMDSALIotDMListofcse", "1.3.6.1.3.1.1.8.12", "S"),
            ...
            new SnmpOidRecord("odlSnmpCardinalNotification", "1.3.6.1.3.1.1.0.1", "NT") };
}
