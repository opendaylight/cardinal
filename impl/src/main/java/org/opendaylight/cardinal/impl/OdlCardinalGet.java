...
public class OdlCardinalGet {
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(OdlCardinalGet.class);

    /**
     * @param host
     * @param community
     * @param strOID
     * @return method to get the snmp string from the agent.
     */
    public String snmpGet(String host, String community, String strOID) {
        ...
        try {
            ...
            host = host + "/" + "161";
            final Address tempHost = new UdpAddress(host);
            TransportMapping transport = new DefaultUdpTransportMapping();
            transport.listen();
            CommunityTarget comtarget = new CommunityTarget();
            comtarget.setCommunity(community1);
            comtarget.setVersion(SnmpConstants.version1);
            comtarget.setAddress(tempHost);
