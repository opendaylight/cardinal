...
import org.opendaylight.cardinal.impl.OdlOpenFlowStats1Meta;
import com.sun.management.snmp.agent.SnmpMib;
import com.sun.management.snmp.agent.SnmpMibTable;
import com.sun.management.snmp.agent.SnmpStandardObjectServer;

public class OdlOpenFlowStats1MetaTest {
    SnmpMib myMib;
    SnmpStandardObjectServer objserv;
    OdlOpenFlowStats1Meta odlOpenFlowStatsMeta = new OdlOpenFlowStats1Meta(myMib, objserv);
    ...
    public void getAttributeNameTest() throws Exception {
        ...
        if (ocpm == "OdlOpenflowNode1") {
            assertEquals("OdlOpenflowNode1", ocpm);
        } else {
            assertEquals(false, ocpm);
        }
    }
