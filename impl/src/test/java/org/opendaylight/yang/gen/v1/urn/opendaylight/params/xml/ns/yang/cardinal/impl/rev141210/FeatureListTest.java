...
public class FeatureListTest {
    ...
    public void odlKarafFeatureListTest() {
    	boolean flag=false;
        if (karafsession) {
        	Map<String, String> odlfeatureList = featureList.odlKarafFeatureList();
        	if(odlfeatureList.size() > 0) flag=true;
    ...
    public void odlKarafFeatureInstalledTest() {
    	boolean flag=false;
        if (karafsession) {
        	List<String> installFeatures = featureList.odlKarafFeatureInstalled();
        	if(installFeatures.size() > 0) flag=true;	
        	assertTrue(flag);
        } else {
        	assertFalse(flag);
        }
    ...
    public void odlKarafFeatureUnInstalledTest() {
    	boolean flag=false;
        if (karafsession) {
        	List<String> uninstallFeatures = featureList.odlKarafFeatureUnInstalled();
        	if(uninstallFeatures.size() > 0) flag=true;
        	assertTrue(flag);
        } else {
        	assertFalse(flag);
        }
    ...
    public void odlKarafFeatureOidTest() {
    	boolean flag=false;
        if (karafsession) {
        	Map<String, String> featureListOid = featureList.odlKarafFeatureOid();
            if(featureListOid.size() > 0) flag=true;
            assertTrue(flag);
        } else {
        	assertFalse(flag);;
        }
